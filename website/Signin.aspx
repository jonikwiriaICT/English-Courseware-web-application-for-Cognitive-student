<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Signin.aspx.cs" Inherits="Default" ValidateRequest="false" %>
            ...
            <div id="wizard_container">
                ...
                <div name="example-1" id="wrapped">
                    ...
                    <div id="bottom-wizard">
                        ...
                        <div class="text-center add_top_10">Create an Account? <strong><a href="Register">Register</a></strong></div>
                    </div>
                    <!-- /bottom-wizard -->
                </div>
            </div>
