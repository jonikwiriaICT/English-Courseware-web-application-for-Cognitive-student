<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="Topic.aspx.cs" Inherits="Topic" ValidateRequest="false" %>
                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        <asp:Panel ID="PnlTopic" runat="server">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <label style="font-size: 12px">Course Name</label>
                                </div>
                                <div class="col-md-9">
                                    <asp:DropDownList ID="course_id" CssClass ="custom-select-sm form-control " runat="server"></asp:DropDownList>

                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
                                    <label style="font-size: 12px">Topic Title</label>
                                </div>
                                <div class="col-md-9">
                                    <asp:TextBox ID="topic_title" CssClass="form-control" runat="server"></asp:TextBox>
