<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="SubTopic.aspx.cs" Inherits="SubTopic" ValidateRequest ="false"  %>
            ...
            <div class="list_general">
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        <br />
                        <br />
                        <asp:Panel ID="PnlSubTopic" runat="server">
                            <asp:HiddenField ID="rec_id" runat="server" />
                            <asp:HiddenField ID="sub_topic_description" runat="server" />
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <label style="font-size: 12px">Topic Name</label>
                                </div>
                                <div class="col-md-9">
                                    
                                  <asp:DropDownList ID="topic_id" CssClass ="form-control custom-select-sm" runat="server"></asp:DropDownList>

                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
                                    <label style="font-size: 12px">Topic Sub Title</label>
                                </div>
                                <div class="col-md-9">
                                    
                                    <asp:TextBox ID="sub_topic_title" CssClass ="form-control " runat="server"></asp:TextBox>

                                </div>
                            </div>
                             <div class="row">
                                <div class="col-md-3">
                                    <label style="font-size: 12px">Sub Topic Pic 1</label>
                                </div>
                                <div class="col-md-9">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <label style="font-size: 12px">Sub Topic Pic 2</label>
                                </div>
                                <div class="col-md-9">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <label style="font-size: 12px">Sub Topic Pic 3</label>
                                </div>
                                <div class="col-md-9">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <label style="font-size: 12px">Sub Topic Pic 4</label>
                                </div>
                                <div class="col-md-9">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <label style="font-size: 12px">Sub Topic Description</label>
                                </div>
                                <div class="col-md-9">
